...
def test_gjdf():
    ...
    look1 = browser.find_element_by_xpath(
        '/html/body/div[1]/section/section/main/div/div[1]/div[3]/div[1]/div[3]/tab'
        'le/tbody/tr[1]/td[12]/div/button/span')
    look1.click()
    time.sleep(3)  # 查看成绩
...
def test_fsdf2():
    ...
    tg = browser.find_element_by_xpath(
        '/html/body/div[1]/section/section/main/div/div[2]/div[1]/div[6]/div/div/div[2]/'
        'form/div[1]/div/div/label[2]/span[1]/span')
    tg.click()
    time.sleep(1)  # 点击驳回
    comm = browser.find_element_by_xpath(
        '/html/body/div[1]/section/section/main/div/div[2]/div[1]/div[6]/div/div/div[2]/fo'
        'rm/div[2]/div/div[1]/textarea')
